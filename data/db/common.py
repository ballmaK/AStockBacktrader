...
MYSQL_CONN_URL = "mysql+mysqldb://" + MYSQL_USER + ":" + MYSQL_PWD + "@" + MYSQL_HOST + ":3309/" + MYSQL_DB + "?charset=utf8mb4"
...
def engine_to_db(to_db):
    MYSQL_CONN_URL_NEW = "mysql+mysqldb://" + MYSQL_USER + ":" + MYSQL_PWD + "@" + MYSQL_HOST + ":3309/" + to_db + "?charset=utf8mb4"
    engine = create_engine(
        MYSQL_CONN_URL_NEW,
        encoding='utf8', convert_unicode=True)
    return engine
...
# 设置基础目录，每次加载使用。
bash_stock_tmp = "/Users/luoE/Documents/Code/data/cache/hist_data_cache/%s/%s/"
